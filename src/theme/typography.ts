...
const studio: FontVariantKind = {
  header: {
    ...
    height: 'clamp(5rem, 6.175vw, 8.5rem)',
    weight: 800,
    color: 'primary',
    font: 'primary',
  },
  ...
  primary: {
    ...
    height: 'clamp(2.25rem, 2.5vw, 3.75rem)',
    weight: 600,
    color: 'primary',
    font: 'primary',
  },
  ...
  secondary: {
    size: 'clamp(1.125rem, 1vw, 1.5rem)',
  ...
  caption: {
    size: 'clamp(0.8125rem, 2.5vw, 1rem)',
    spacing: '$space$3',
...
const symbol: FontVariantKind = {
  hero: {
    size: 'clamp(8rem, 2.5vw, 13.5rem)',
    height: 'clamp(9.25rem, 2.5vw, 16.5rem)',
    weight: 700,
    color: 'primary',
    font: 'mono',
  },
  ...
  primary: {
    size: 'clamp(1.125rem, 2.5vw, 1.625rem)',
    height: 'clamp(1.5rem, 2.5vw, 2rem)',
    weight: 600,
    color: 'primary',
    font: 'mono',
